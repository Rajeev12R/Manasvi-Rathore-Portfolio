    ...
    >
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-3 text-center mb-8">
          ...
          >
            Gaining practical insights and skills through internships and
            volunteer roles across media production and event management.
          </p>
        </div>
...
function ExperienceCard({ experience, index, isLast }: ExperienceCardProps) {
  ...
  return (
    <div
      className={`relative pl-10 ${!isLast ? "pb-10" : ""} slide-up`}
        ...
        <CardHeader className="pb-3">
          <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-x-4 gap-y-1">
            <div className="flex-1">
              <CardTitle className="text-xl font-heading font-semibold text-foreground mb-1">
                {experience.role}
              </CardTitle>
